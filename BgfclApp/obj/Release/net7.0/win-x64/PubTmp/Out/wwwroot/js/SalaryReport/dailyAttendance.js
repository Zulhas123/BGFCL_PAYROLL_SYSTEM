...
//function getAttendanceList(pageLength) {
//    $.ajax({
//        url: '/api/Users/GetAttendanceByMonthId?monthId=202502',
//        method: 'GET',
//        success: function (json) {
//            if (!json.data) {
//                console.warn("No data found.");
...
//                grouped[item.employeeId][date] = item.isPresent ? '1' : '0';
//            });
...
//            // ➕ Add "Total Days" column at the end
//            const totalDaysColumn = {
//                data: 'totalDays',
//                title: 'Total Days',
//                className: 'text-center',
...
//            // Step 3: Calculate totalDays for each employee
//            Object.values(grouped).forEach(employee => {
//                let total = 0;
//                allDates.forEach(date => {
//                    total += parseInt(employee[date] || '0');
...
//            // Step 4: Reinitialize DataTable
//            if ($.fn.DataTable.isDataTable('#dailyAttendencelist')) {
//                _dataTable.destroy();
//                $('#dailyAttendencelist').empty(); // Clear old table head/body
//            }
...
//                            $(sheet).find('row:first c').attr('t', 'inlineStr');
//                        }
//                    },
//                    'copy', 'pdf', 'print'
//                ],
