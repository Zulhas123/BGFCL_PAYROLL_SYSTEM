...
function loadInitialData() {
    ...
    $.ajax({
        ...
        success: function (responseObject) {
            ...
            // Filter only December months (monthId ends with 12)
            let decemberMonths = months.filter(m => parseInt(m.monthId) % 100 === 12);

            $.each(decemberMonths, function (key, item) {
    ...
    $('#providentFoundForm').on('submit', function (e) {
