...
$(document).ready(function () {
    ...
    $('#submit_button').on('click', function () {
        ...
        let eidul_fitar = $('#eidul_fitar').val();
        eidul_fitar = eidul_fitar == '' ? 0 : eidul_fitar;
        let eidul_ajha = $('#eidul_ajha').val();
        eidul_ajha = eidul_ajha == '' ? 0 : eidul_ajha;
        let baishakhi = $('#baishakhi').val();
        baishakhi = baishakhi == '' ? 0 : baishakhi;
        ...
        let _object = {
            ...
            eidul_fitar: parseFloat(eidul_fitar),
            eidul_ajha: parseFloat(eidul_ajha),
            baishakhi: parseFloat(baishakhi),
...
function onEditConfirmed() {
    ...
    $.ajax({
        ...
        $('#eidul_fitar').val(responseObject.data.eidul_fitar);
        $('#eidul_ajha').val(responseObject.data.eidul_ajha);
        $('#baishakhi').val(responseObject.data.baishakhi);
